...
\begin{table}[htb]
  ...
  \begin{tabularx}{\textwidth}{X*{7}{c}}
    ...
    GeoGebra~\cite{Hohenwarter:2004:CDGACSSG}
      ...
      & \checkmark{}
    \\\midrule
    GeoSolver~\cite{Van:2009:GeoSolver,Van:2009:NRCRASSGC}
      & \checkmark{}
      & \checkmark{}
      & \xmark{}
      & \xmark{}
...
definitions, making it easily extendable.
...
\begin{figure}[htb]
  ...
  {\scriptsize Source: \url{http://geosolver.sourceforge.net} (Jan 2019)}
...
\ac{TikZ}~\cite{Tantau:2015:tikz-manual}, along with its underlying lower-level
...
``\acl{TikZ}'', a recursive acronym, which translates to ``\acs{TikZ} is no
drawing program''.  As mentioned, the user instead programmatically describes
their drawings.
