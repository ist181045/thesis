...
library, used in well-known projects such as OpenSCAD.  It is a very mature
software library with decades of Ph.D.-grade research results, still being
actively maintained to this day.  Being an Open Source project, one can easily
contribute to it by reporting issues or bugs in the software as well as directly
submitting patches.\footnote{The library's source is hosted on GitHub at
