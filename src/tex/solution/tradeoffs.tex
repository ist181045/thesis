...
are not \emph{immediately} fixable lest we forget \ac{CGAL} is still an Open
Source project arguably anyone can contribute to.  Alas, said contribution
deployments are still out of our control.  In hindsight, however, it can be
considered just an inconvenience since it is a project that is actively
