...
mapping the kernels and numeric types, giving the user a choice.  Regardless,
it is important to note (I think) that many, and I do mean \textit{many}, of
the primitives came from CGAL alone, leaving us with a platform to build upon
that didn't require much building at all, another boon of our approach.}
