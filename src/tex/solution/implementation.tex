...
\todo{Might just use the names on the solution diagram for the section headings.
But "Wrapper Code" looks ugly.}
...
from several PhDs, open source ⇒ open to contributions, lots of contributors,
active development, \textit{et cetera}).}
...
% direct impls in constraintGM are due to overconfidence in maxima
