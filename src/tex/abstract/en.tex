...
greater extent, geometric constraints that condition the geometric models being
...
geometric shapes that would otherwise require substantially more complex
...
and frees the programmer from the specification of unnecessary details.  Said
primitive operations could include the definition of incidence relations,
parallelism or perpendicularity, distances, and angles; to which the various
