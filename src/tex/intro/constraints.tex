...
\begin{itemize}
  ...
  development~\cite{Bettig:2011:GCSPC:1.3593408}.
...
in~\cite{Buchanan:1993:CDS}; \Citet{Kondo:1992:AMMDRGM} further reports a
...
\begin{itemize}
  ...
  deformations that minimize strain energy; \Citet{Xu:2009:SDUAC} entails
